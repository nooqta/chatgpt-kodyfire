    ...
    generate(_data, api = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const ora = yield (0, esm_ts_1.requiresm)("ora");
                let conversationId, parentMessageId = null;
                let res = yield ora.oraPromise(api.sendMessage(prompt, {}), {
                    text: prompt,
                });
                ...
                while (keepConversation) {
                    ...
                    res = yield ora.oraPromise(api.sendMessage(prompt, {
                        conversationId,
                        parentMessageId,
                    }), {
                        text: prompt,
